...
main() {
    ...
    run_p7
    run_p8
    log OK "vps-setup selesai: P0-P8 terpasang (Foundation, Git/GitHub CLI, Node.js 20, Python, Docker, PostgreSQL/Redis/MinIO, Caddy, Developer/AI CLI tools, Project requirements)."
}
